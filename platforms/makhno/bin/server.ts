...
import dbutils from '@yttrex/lib/dbutils';
import security from  '@yttrex/lib/security';
import { makeApp } from './app';
import mongo3 from '../../yttrex/backend/lib/mongo3';

const d = debug('makhno');
...
const start = async (): Promise<void> => {
  ...
  const initialSanityChecks: () => Promise<void> = async () => {
